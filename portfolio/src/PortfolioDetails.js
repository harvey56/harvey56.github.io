	...
	render(){
		return(
			<div className="card-columns">
			  <div className="card">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_R04 + "/image/small.png"} alt="Card image cap" />
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_R01 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			      <div className="card-body">
				      ...
				      <div className = "text-center">
					      ...
					      <a href = "https://github.com/harvey56/image-search-layer" className = "btn btn-link active" role="button" aria-pressed="true">View Code</a>
					  </div>
				  </div>
			  </div>
			  ...
			  <div className="card p-3">
			      <div className="card-body">
				      ...
				      <div className = "text-center">
					      ...
					      <a href = "https://github.com/harvey56/URL-shortener-service" className = "btn btn-link active" role="button" aria-pressed="true">View Code</a>
					  </div>
				  </div>
			  </div>
			  ...
			  <div className="card p-3">
			      <div className="card-body">
				      ...
				      <div className = "text-center">
					      ...
					      <a href = "https://github.com/harvey56/request-header-parser" className = "btn btn-link active" role="button" aria-pressed="true">View Code</a>
					  </div>
				  </div>
			  </div>
			  ...
			  <div className="card p-3">
			      <div className="card-body">
				      ...
				      <div className = "text-center">
					      ...
					      <a href = "https://github.com/harvey56/timestamp_microservice" className = "btn btn-link active" role="button" aria-pressed="true">View Code</a>
					  </div>
				  </div>
			  </div>
			  ...
			  <div className="card">
			    <div className="card-body">
			      ...
			      <div className = "text-center">
				      <a href = {URL_W01_GH} className = "btn btn-link active" role="button" aria-pressed="true">View App</a>
				      <a href = {URL_W01_Full} className = "btn btn-link active" role="button" aria-pressed="true">View Code</a>
				  </div>
			    </div>
			  </div>			  

			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_R03 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_R02 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_D302 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_D303 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_D301 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_JQ01 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_JQ02 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_JQ03 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
			  ...
			  <div className="card p-3">
			    <img className="card-img-top" src={base_codepen_URL + "pen" + URL_JQ04 + "/image/small.png"} alt="Card image cap" />
			      <div className="card-body">
